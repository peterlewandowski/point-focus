...
const ZoomImage = React.forwardRef<HTMLImageElement, IZoomImageTypes>(
  ({ src, zoomLevel, fadeDuration, top, left, isZoomed, onLoad, onDragStart, onDragEnd, onClose, onFadeOut, closeButtonRef }, ref) => {
    //Add custom class
    ...
    return (
      <>
        <img
          ...
          style={{
            transform: `translate(${left}px, ${top}px) scale(${zoomLevel})`,
